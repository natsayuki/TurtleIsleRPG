                    ...
                    for button in button_list:
                        if button.rect.collidepoint(event.pos):
                            ...
                            if button.text == "Level tree":
                                ...
                                for i in equipment:
                                    if equipment[i] != None:
                                        equipmentsprite = base_sprite(image=equipment[i].image)
                                        equipment_sprites.append(equipmentsprite)
                                    ...
                                    for i in button_list:
                                        equipment_list.remove(i)
                                    button_list = []
                                    inventory_menu = base_sprite(image = "images\\inventorybar.png",x=680,y=250)
                                    equipment_list.add(inventory_menu)
                                    equipment_list.remove(exitbutton)
                                    equipment_list.add(exitbutton)
                    ...
                    for item in inventory_temp:
                        if item.rect.collidepoint(event.pos):
                            ...
                            for i in equipment_list_temp:
                                if i.__class__.__name__ == "text" or i in equipment_sprites: #or i.__class__.__name__ == "equipable" or  i.__class__.__name__ == "keyItem" or  i.__class__.__name__ == "consumable":
                                    equipment_list.remove(i)
                            equipment = equipment_turtle.listSelfTest()
                            equipment_sprites = []
                            for i in equipment:
...
#TODO if you close the party menu with a single turtle selected it doesnt reset the bool but removes the pointer (turtle invisibly selected next time you open menu)
#TODO if you switch turtles with attack menu open it doesnt reset the menu leaving you with the previous turtles attacks (causes errors if any attacks are used)
#TODO add crit hits
